...
def enviar_correo(nombre, correo, titulo, descripcion):
    ...
    mensaje = descripcion
    email_from = correo
    email_to = ['andrea.mendoza@saroautomation.com','andres.gomez@saroautomation.com','jesus.sanchez@saroautomation.com','dariorosas@saroautomation.com']  # Tu correo electrónico para recibir el mensaje
